              ...
              <div className="row">
                <div className="col-md-4">
                  ...
                  <div className="box" style={{ marginTop: "1rem" }}>
                    <div className="twitter__title">
                      <h4>
                        <i class="fas fa-virus"></i> Covid 19 India
                      </h4>
                      <Covid />
                    </div>
                  </div>
                ...
                <div className="col-md-4">
                  ...
                  <div className="box" style={{ marginTop: "1rem" }}>
                    <div className="twitter__title">
                      <h4>
                        <i className="fab fa-twitter"></i> Twitter Trending
                      </h4>
                    </div>
                    <TwitterTrends />
                  </div>
                  <div className="box" style={{ marginTop: "1rem" }}>
                    <div className="twitter__title">
                      <h4>
                        <i className="fas fa-trophy"></i> Live Score
                      </h4>
                    </div>
                    <LiveScore />
                  </div>
              ...
              <Modal.Body className="settings-model-body">
                {pinCorrect ? (
                  <div className="website-details">
                    ...
                    <h4>
                      <i className="far fa-list-alt"></i> Saved Account(s)
                    </h4>
                    <hr></hr>
